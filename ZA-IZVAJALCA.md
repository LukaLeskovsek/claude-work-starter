...
Naš standard določa prvo raven nastavitve. Uporabnik pojasni delo, potrdi podatke in način sodelovanja ter začne uporabljati Claude. Tehnične odločitve in odpravljanje težav so odgovornost izvajalca.
...
- Zaključek nastavitve je ena izvedena naloga in preizkus uporabe, ne samo ustvarjene datoteke.
...
| Lokacija | Namen |
| --- | --- |
| Zasebna lokalna mapa | `MOJ-DELOVNI-PROFIL.md`, besedili za nastavitve Chat in Cowork ter kratka navodila za uporabo |
